...
class test_inherit_basemodel(unittest.TestCase):
    """Test if user inherit """
    def test_instance(self):
        """see if user is instance of BaseModel"""
        user = Amenity()
...
class TestAmenity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Test Amenity has attribute name, it's as empty string"""
        amenity = Amenity()
    ...
    def test_to_dict_creates_dict(self):
        """to_dict method creates with proper attrs"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_to_dict_values(self):
        """that values in dict returned from to_dict are correct"""
    ...
    def test_str(self):
        """that str method has correct output"""
        amenity = Amenity()
